...
![EMG correlation with base signal before the aligning by correlation](https://github.com/RobbeElsermans/6-DSP/tree/main/DOCS/assets/EMG_corr_base_before_align.png)
...
![EMG correlation with base signal after the aligning by correlation](https://github.com/RobbeElsermans/6-DSP/tree/main/DOCS/assets/EMG_corr_base_after_align.png)
...
![EMG correlation with base signal after resampling with correct sample rate](https://github.com/RobbeElsermans/6-DSP/tree/main/DOCS/assets/EMG_corr_base_after_resample.png)
...
![portion of synchronized signals](https://github.com/RobbeElsermans/6-DSP/tree/main/DOCS/assets/sync_signals_after_resample.png)
